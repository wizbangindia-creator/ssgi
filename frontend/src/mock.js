...
export const megaNav = [
  ...
  },
  {
    ...
    columns: [
      ...
      { title: "Pharmacy & Sciences", items: [
        ...
        { label: "B.Sc Radiology", to: "/programs/bsc-radiology" },
        { label: "B.Sc OTT", to: "/programs/bsc-ott" },
        { label: "BMLS", to: "/programs/bmls" },
      ] },
  ...
  },
  {
    ...
    feature: {
      ...
      cta: { label: "See All Colleges", to: "/colleges" },
    },
    columns: [
      { title: "Constituent Colleges", items: [
        { label: "Sri Sai College of Engg. & Tech.",  to: "/colleges/college-of-engineering" },
